  ...
  return (
    ...
    >
      <div className="flex items-center justify-between pb-3 border-b border-[rgba(255,255,255,0.07)]">
        ...
        <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-[#8B5CF6]/12 text-[#8B5CF6] border border-[#8B5CF6]/25">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  {alert.contractId && (
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg bg-[#8B5CF6] hover:bg-[#7C4FE0] text-white font-bold text-[10px] flex items-center gap-1 cursor-pointer transition-all active:scale-95 shrink-0"
                    >
