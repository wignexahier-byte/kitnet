      ...
      <div className="p-4 sm:p-5 bg-[#121420] border border-white/[0.08] rounded-2xl shadow-lg flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 overflow-x-auto no-scrollbar shrink-0">
          ...
          <div className="px-3 py-1.5 rounded-xl bg-[#161825] border border-white/[0.06] flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-white font-mono tabular-nums">{stats.total}</span>
          </div>

          <div className="px-3 py-1.5 rounded-xl bg-[#161825] border border-white/[0.06] flex items-center gap-2">
            <Award className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
            <span className="text-xs text-slate-400">Score Médio:</span>
            <span className="text-xs font-bold text-emerald-400 font-mono tabular-nums">{stats.avgScore} pts</span>
          </div>
        </div>
      </div>

      {/* Filter and Search Bar - Mobile Ergonomic & No Truncation */}
        ...
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full bg-[#161825] border border-white/[0.08] hover:border-white/[0.15] rounded-xl pl-9 pr-9 py-2 text-xs sm:text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:border-violet-500 focus:ring-1 focus:ring-violet-500/40 transition-all"
            />
            {searchQuery && (
              <button
          ...
          {/* Segment & Score Filter Controls */}
          <div className="flex items-center gap-2 flex-wrap md:flex-nowrap">
            {/* Segment Filter Buttons */}
            <div className="flex bg-[#161825] p-1 rounded-xl border border-white/[0.06] gap-1 shrink-0 overflow-x-auto no-scrollbar">
              <button
                onClick={() => setFilterType('todos')}
                className={`h-8 px-3 rounded-lg text-xs font-semibold transition-all duration-150 cursor-pointer flex items-center gap-1.5 shrink-0 active:scale-95 select-none ${
                  filterType === 'todos'
              ...
              >
                ...
                <span>Todos ({clientList.length})</span>
              </button>
              ...
              >
                ...
                <span>Kitnets ({stats.kitnets})</span>
              </button>
            </div>
            ...
            <div className="relative shrink-0">
              <select
                ...
                className="h-9 bg-[#161825] border border-white/[0.08] hover:border-white/[0.15] text-slate-200 text-xs font-semibold rounded-xl pl-3 pr-8 focus:outline-none focus:border-violet-500 cursor-pointer transition-all appearance-none"
              >
