  ...
  const modalContent = (
    ...
    >
      ...
      >
        ...
        {/* Filtros de topo discretos */}
        {alerts.length > 0 && (
          <div className="px-3 sm:px-4 py-2.5 bg-[#090C12] border-b border-white/[0.05] flex items-center gap-2 overflow-x-auto scrollbar-none shrink-0">
            <button
              type="button"
              onClick={() => setActiveFilter('all')}
              className={`px-3 py-1.5 rounded-xl text-xs font-semibold whitespace-nowrap transition-all cursor-pointer inline-flex items-center gap-2 shrink-0 ${
                activeFilter === 'all'
                  ? 'bg-white/[0.14] text-white shadow-xs border border-white/[0.15]'
                  : 'text-slate-400 hover:text-slate-200 hover:bg-white/[0.04] border border-transparent'
              }`}
            >
              <span className="shrink-0">Todos</span>
              <span className="min-w-[20px] h-5 px-1.5 rounded-full bg-white/[0.10] text-slate-200 text-[10px] font-bold shrink-0 inline-flex items-center justify-center leading-none">
                {counts.all}
              </span>
            </button>
            ...
            {counts.critical > 0 && (
              ...
              >
                ...
                <span className="min-w-[20px] h-5 px-1.5 rounded-full bg-rose-500/25 text-rose-200 text-[10px] font-bold shrink-0 inline-flex items-center justify-center leading-none border border-rose-500/30">
                  {counts.critical}
                </span>
              </button>
            )}
            ...
            {counts.expense > 0 && (
              ...
              >
                ...
                <span className="min-w-[20px] h-5 px-1.5 rounded-full bg-emerald-500/20 text-emerald-200 text-[10px] font-bold shrink-0 inline-flex items-center justify-center leading-none border border-emerald-500/30">
                  {counts.expense}
                </span>
              </button>
            )}
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xl text-xs font-semibold whitespace-nowrap transition-all cursor-pointer inline-flex items-center gap-2 shrink-0 ${
                  activeFilter === 'rental'
                    ...
                    : 'text-slate-400 hover:text-sky-300 hover:bg-sky-500/10 border border-transparent'
                }`}
              >
                <span className="shrink-0">Locações</span>
                <span className="min-w-[20px] h-5 px-1.5 rounded-full bg-sky-500/20 text-sky-200 text-[10px] font-bold shrink-0 inline-flex items-center justify-center leading-none border border-sky-500/30">
                  {counts.rental}
                </span>
              </button>
            )}
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xl text-xs font-semibold whitespace-nowrap transition-all cursor-pointer inline-flex items-center gap-2 shrink-0 ${
                  activeFilter === 'documentos'
                    ...
                    : 'text-slate-400 hover:text-amber-300 hover:bg-amber-500/10 border border-transparent'
                }`}
              >
                <span className="shrink-0">Documentos</span>
                <span className="min-w-[20px] h-5 px-1.5 rounded-full bg-amber-500/20 text-amber-200 text-[10px] font-bold shrink-0 inline-flex items-center justify-center leading-none border border-amber-500/30">
                  {counts.documentos}
                </span>
              </button>
            )}
                  ...
                  <div className="shrink-0 flex items-center">
                    {isExpense ? (
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-[#25D366]/15 hover:bg-[#25D366]/25 border border-[#25D366]/30 text-[#25D366] text-xs font-bold flex items-center gap-1.5 transition-all cursor-pointer active:scale-95 shadow-xs"
                      >
                      ...
                      <button
                        ...
                        className="px-2.5 py-1.5 rounded-lg bg-white/[0.06] hover:bg-white/[0.12] border border-white/[0.08] text-slate-300 hover:text-white text-xs font-medium flex items-center gap-1 transition-all cursor-pointer active:scale-95"
                      >
                        <span>Ver</span>
